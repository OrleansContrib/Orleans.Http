 ...
 * onPositionChange command add to terminal
 *
...
(function($, undefined) {
    ...
    */
    ...
    $.fn.cmd = function(options) {
        ...
        // on mobile you can't delete character if input is empty (command
        ...
        function keydown_event(e) {
            ...
            if (enabled) {
                ...
                if (reverse_search && (e.which === 35 || e.which === 36 ||
                    ...
                    redraw();
                    // finish reverse search and execute normal command handler
    ...
    // there is only one popstate command
    ...
    $.fn.terminal = function(init_interpreter, options) {
        ...
        // :: as command handler for popstate
        // ---------------------------------------------------------------------
        ...
        function complete_helper(command, string, commands) {
            ...
            var regex = new RegExp('^' + $.terminal.escape_regex(string), 'i');
            var matched = [];
                ...
                if (e.which === 68 && e.ctrlKey) { // CTRL+D
                    ...
                    if (strings.length == 1) {
                        ...
                        for (i=strings.length-1; i>0; i--) {
                            ...
                            if (strings[i-1][strings[i-1].length-1] == '\\' || strings[i-1] === 'to') {
                    ...
                    case 'array':
                        ...
                        break;
                    default:
                        // terminal will not catch this because it's an command
        ...
        if (this.length > 1) {
            ...
            */
            ...
            make_interpreter(init_interpreter, settings.login, function(itrp) {
                ...
                // touch devices need touch command to get virtual keyboard
